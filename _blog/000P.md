...
![[writeups/hackthebox/permx/images/website-overview.png]]
...
![simple-php-file-executed](simple-php-file-executed.png)
...
if [| "$target" == *..* ](%20"$target"%20!=%20/home/mtz/*%20); then
...
- mtzsec. (2024, July 06). <span class="reference-title">PermX</span>. _HTB Labs_. [https://app.hackthebox.com/machines/PermX](https://app.hackthebox.com/machines/PermX)
