...
- ASCII file containing basic user attributes.
- Each entry represents a user.
- Attributes of an entry are separated by a colon (`:`). For this reason, you shouldn't use a colon as the value of an attribute.
...
| <span class="highlight">Shell</span>         | Specifies the initial program or [[20250128095114\|shell]] that is executed after a user invokes the login command or su command. Usually the default shell is [[20250309213404\|Bash]].                                                                                         |

## References

- IBM. (n.d.). <span class="reference-title">/etc/passwd File</span>. [https://www.ibm.com/docs/en/aix/7.3?topic=files-etcpasswd-file](https://www.ibm.com/docs/en/aix/7.3?topic=files-etcpasswd-file)
- Linuxize. (2019, December 19). <span class="reference-title">Understanding the /etc/passwd File</span>. [https://linuxize.com/post/etc-passwd-file/](https://linuxize.com/post/etc-passwd-file/)
