...
Here is an example, you can change the working directory from `/usr` to `/usr/bin` in two different ways, either using an [[Computing/20241101182026|absolute pathname]]:
