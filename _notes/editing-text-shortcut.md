...
- Prakash, A. (2023, September 20). <span class="reference-title">13 Linux terminal shortcuts Every power Linux user must know</span>. Linux Handbook. [https://linuxhandbook.com/linux-shortcuts](https://linuxhandbook.com/linux-shortcuts/)
...
- Effective Shell. (n.d.). <span class="reference-title">Fly on the command Line</span>. https://effective-shell.com/part-2-core-skills/fly-on-the-command-line#delete-a-word-or-undo-a-mistake
