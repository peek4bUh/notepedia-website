...
If you don't have a terminal emulator running, several terminal sessions continue to run behind the graphical desktop. You can access these sessions called **virtual consoles**, by pressing `CTRL-ALT-F1` through `CTRL-ALT-F6` on most Linux distributions.
...
- [[Computing/20240913122230|Terminal Emulator]]
