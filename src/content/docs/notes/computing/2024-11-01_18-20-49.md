---
parent: "[[20241105213707|Bash Prompt]]"
title: Bash Prompt Escape Sequences
---

# Bash Prompt Escape Sequences

[[20250309213404|Bash]] allows these prompt strings to be customized by inserting a number of backslash-escaped special characters that are decoded as follows:
...
- Orr, G. (2003, November, 06). <span class="reference-title">Bash Prompt Escape Sequences</span>. The Linux Documentation Project. [https://tldp.org/HOWTO/Bash-Prompt-HOWTO/bash-prompt-escape-sequences.html](https://tldp.org/HOWTO/Bash-Prompt-HOWTO/bash-prompt-escape-sequences.html)
- HTB Academy. (n.d.). <span class="reference-title">Linux Fundamentals: The Shell: Prompt Description</span>. [https://academy.hackthebox.com/module/18/section/66](https://academy.hackthebox.com/module/18/section/66)

## See Also

- [[20241102154723|Bash Prompt Colors]]
