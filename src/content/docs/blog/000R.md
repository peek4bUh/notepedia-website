...
skills: nmap, netcat
tags: [pentesting, writeup, hackthebox]
title: Lame Writeup
---

![20250129104304](../../../assets/images/writeups/000O/20250129104304.png)
...
Looking the samba version I found [this](https://github.com/amriunix/CVE-2007-2447). So following the Python script I did the following.
...
- ch4p. (2017, March 14). <span class="reference-title">Lame</span>. HTB Labs. [https://app.hackthebox.com/machines/Lame](https://app.hackthebox.com/machines/Lame)
